...
namespace Quantower_OrderFlow_Signal_Indicator
{
    /// <summary>
    ...
    /// </summary>
	public class Quantower_OrderFlow_Signal_Indicator : Indicator
    {
        /// <summary>
        /// Indicator's constructor. Contains general information: name, description, LineSeries etc. 
        /// </summary>
        public Quantower_OrderFlow_Signal_Indicator()
            : base()
        {
            // Defines indicator's name and description.
            Name = "Quantower_OrderFlow_Signal_Indicator";
